      ...
      <form onSubmit={handleSubmit} className="p-4 border-t border-yellow-200">
        <div className="flex">
          <input
            ...
            className="flex-grow bg-transparent rounded-l px-2 py-1 focus:outline-none"
            placeholder="Type a message..."
          />
          <button type="submit" className="bg-yellow-500 text-white px-4 py-2 rounded-r hover:bg-yellow-600 transition-colors">
            Send
          </button>
        </div>
      </form>
